...
<div class="am-cf admin-main">
  ...
  <div class="admin-sidebar">
    ...
    <div class="am-panel am-panel-default admin-sidebar-panel">
      <div class="am-panel-bd">
        ...
        <p>时光静好，与君语；细水流年，与君同。—— Littlepawn</p>
      </div>
    </div>
  </div>
  <!-- sidebar end -->
  ...
  <div class="admin-content">
    ...
    <ul class="am-avg-sm-1 am-avg-md-4 am-margin am-padding am-text-center admin-content-list ">
      <li><a href="#" class="am-text-success"><span class="am-icon-btn am-icon-file-text"></span><br/>新增页面<br/>0</a></li>
    ...
    <div class="am-g">
      <div class="am-u-sm-12">
        <table class="am-table am-table-bd am-table-striped admin-content-table">
          <thead>
          <tr>
            <th>ID</th><th>标题</th><th>简介</th><th>管理</th>
          </tr>
          </thead>
          <tbody>
          <?php
          ...
          <tr><td><?php echo $hotel['_id'];?></td><td><?php echo $hotel['title'];?></td>
...
<footer>
  <hr>
  <p class="am-padding-left">© 2016 Littlepawn </p>
</footer>
